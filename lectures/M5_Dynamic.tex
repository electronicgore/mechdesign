...
\begin{itemize}
	...
	\item \structure{Reporting strategies} given by $\rho_i = \{r_{i,t}\}_{t=0}^T$, where $r_{i,t}: \Theta_i \times H_t \to \Theta_i$ and $H_t$ is the set of \structure{public histories} $h_t = \{k_s,r_{i,s}\}_{s < t}$.
