...
\begin{itemize}
	...
	\end{itemize}
	\item In \alert{static} model, \alert{virtual surplus} is (\emph{note inconsistency in how VS is defined here vs before!})
...
\begin{itemize}
	...
	\item Note that this will pin down the ``expected-at-time-0'' payments $\mathbb{E}_\varepsilon [p_t(\theta^t)|\theta_0]$. These payments can be redistributed across periods and histories since both seller and buyer are risk-neutral.
	\begin{itemize}
