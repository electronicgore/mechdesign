...
\begin{ex}
	...
	\begin{enumerate}
		...
		\item Matching $\mu$ generated by the C-DA algorithm is $C'$-optimal. However, matching $\mu' = \{ (c_1, s_2, s_4), (c_2, s_1), (c_3, s_3) \}$ is strictly preferred to $\mu$ by all colleges in $C$. How can you explain this contradiction?
	\end{enumerate}
	\ifsolutions
	\subsection*{Solution}
