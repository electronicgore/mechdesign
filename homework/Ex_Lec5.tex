...
\begin{ex}
	...
	\ifsolutions
		...
		\phi(\theta_{-i}=H|\theta_{i}=H)\cdot 1 + \phi(\theta_{-i}=L|\theta_{i}=H)\cdot 0\\
		...
		\frac{2}{3}(0-C_{1}-C_{2}ln(3)) + \frac{1}{3}(1-C_{1}-C_{2}ln(3)+C_{2}ln(2))\\
		\rightarrow
		\frac{1}{3}-C_{1}-C_{2}ln(3)+\frac{2}{3}ln(2) \geq  \frac{2}{3}-C_{1}-C_{2}ln(3)+\frac{1}{3}ln(2)\\
