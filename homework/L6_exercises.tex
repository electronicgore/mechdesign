...
\section{Optimal Procurement Mechanism}
	...
	\end{align*}
	%NOTE: to be clear, this is not a budget balance restriction, this is the accounting condition
	\begin{enumerate}
...
\begin{enumerate}
	...
	\begin{align*}
		...
		\\
		&=\int_0^1(v(\theta)-\theta)k(\theta)\phi(\theta)d\theta  -\int_0^1\int_\theta^1k(s) ds \phi(\theta) d\theta-U_S(1|1)
		\\
