...
\captionsetup[subfigure]{subrefformat=parens,labelformat=empty}
...
\begin{figure}
	\begin{center} 
		\subfloat[][Panel (a): $k(\theta)$ fitting the problem]{
		...
		\hfill
		\subfloat[][Panel (b): $k(\theta)$ not fitting the problem]{
			\begin{tikzpicture}[scale=5.5]
				\filldraw[yellow, opacity=0.3] (0,0) -| (1,1) -| (0,0);
		...
		\caption{Allocation rules for Problem \ref{prb:implement_arb_k}.}
	\end{center}
\end{figure}
