...
\section{Optimal Procurement Mechanism}
	...
	\begin{enumerate}
		...
		\item IC ERP can be written for this problem as $U_S(\theta|\theta) = U_S(1|1) + \int_{\theta}^{1} k(s) ds $. Using this expression, show that the buyer's expected utility in any IC DRM $(k,t)$ is given by:
		\begin{align*}
