...
\begin{itemize}
	...
	\item This lecture mostly follows Bergemann and Välimäki (2019).
\end{itemize}
\lyxframeend
...
\begin{itemize}
	...
	\item Enter \structure{dynamic pivot mechanism}! (Bergemann and Välimäki, 2010)
\end{itemize}
\lyxframeend
...
\begin{itemize}
	...
	\item Neat mathematical result, but I haven't found any good intuitive explanations of where it comes from. So here's my best guess at why this works:
	\begin{itemize}
		\item Principal prefers to raise all $b_t$ while lowering all $V_{t+1}$
		\item ...because giving high $b_t$ cheaper than promising high $V_{t+1}$
		\item ...because high util promise $\Rightarrow$ high $b_{t+1}$ $\Rightarrow$ less risk-aversion in that region (DARA) $\Rightarrow$ more info rents...?
	\end{itemize}
\end{itemize}
\lyxframeend
