...
\begin{theorem}[Krishna and Perry (2015), part 1]
	...
	\end{itemize}
\end{theorem}
Prove EFF and BIC (hint: analogous to AGV).
\lyxframeend
...
\lyxframe{IR+BB ?}
\begin{itemize}
	\item So we have two mechanisms that implement the efficient $k^*$ in \structure{quasilinear} model:
	\begin{itemize}
		\item AGV: BIC + BB,
		\item gVCG: BIC + IIR.
	\end{itemize}
...
\begin{theorem}[Payoff Equivalence for BIC mechanisms]
	...
	\structure{if \quad $\mathbb{E}_{\theta_{-i}} k(\theta_i, \theta_{-i}) = \mathbb{E}_{\theta_{-i}} k'(\theta_i, \theta_{-i})$} for all $i,\theta_i$,
