...
\begin{itemize}
	...
	\item Will see a common theme though on the flip side of dynamic mechanisms.
\end{itemize}
\lyxframeend
...
\begin{itemize}
	\item One risk-neutral principal, one \alert{risk-averse} agent, common discount factor $\delta$.
	\item Agent receives random exogenous income $y_t \sim i.i.d. F[\underline{y},\bar{y}]$.
	\begin{itemize}
		\item Concave utility $u(y)$, so optimal to smooth consumption.
	\end{itemize}
	...
	\begin{itemize}
		...
		\item %TODO: efficient or rev-max?
	\end{itemize}
